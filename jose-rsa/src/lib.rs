...
impl jose_core::__private::Sealed for Rs256 {}
...
pub type SigningKey = jose_core::SigningKey<Rs256>;
pub type VerifyingKey = jose_core::VerifyingKey<Rs256>;

pub fn signing_key(private_key: rsa::RsaPrivateKey) -> SigningKey {
    jose_core::key::Key::new(private_key)
}

pub fn verifying_key(public_key: rsa::RsaPublicKey) -> VerifyingKey {
    jose_core::key::Key::new(public_key)
}

pub fn verifying_key_from_signing(key: &SigningKey) -> VerifyingKey {
    jose_core::key::Key::new(rsa::RsaPublicKey::from(key.inner()))
}
