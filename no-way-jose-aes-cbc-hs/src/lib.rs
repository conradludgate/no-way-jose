//! AES-CBC with HMAC-SHA (encrypt-then-MAC) for JWE: [`A128CbcHs256`], [`A192CbcHs384`],
//! [`A256CbcHs512`].
//!
...
//! [no-way-jose-core](https://docs.rs/no-way-jose-core). Use them as the `CE` parameter on
//! [`CompactJwe`](no_way_jose_core::CompactJwe) with your chosen key-management algorithm.
//!
//! ```
