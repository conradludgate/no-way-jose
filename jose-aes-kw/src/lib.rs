...
use jose_core::jwe_algorithm::{JweKeyManagement, KeyDecryptor, KeyEncryptor};
use jose_core::key::{Decrypting, Encrypting, HasKey};
...
pub mod a128kw {
    ...
    pub type EncryptionKey = jose_core::EncryptionKey<super::A128Kw>;
    pub type DecryptionKey = jose_core::DecryptionKey<super::A128Kw>;

    pub fn encryption_key(
        bytes: impl Into<Vec<u8>>,
    ) -> Result<EncryptionKey, jose_core::JoseError> {
        Ok(jose_core::key::Key::new(super::make_kek(bytes, 16)?))
    }

    pub fn decryption_key(
        bytes: impl Into<Vec<u8>>,
    ) -> Result<DecryptionKey, jose_core::JoseError> {
        Ok(jose_core::key::Key::new(super::make_kek(bytes, 16)?))
    }
}
...
pub mod a192kw {
    ...
    pub type EncryptionKey = jose_core::EncryptionKey<super::A192Kw>;
    pub type DecryptionKey = jose_core::DecryptionKey<super::A192Kw>;

    pub fn encryption_key(
        bytes: impl Into<Vec<u8>>,
    ) -> Result<EncryptionKey, jose_core::JoseError> {
        Ok(jose_core::key::Key::new(super::make_kek(bytes, 24)?))
    }
...
pub mod a256kw {
    ...
    pub type EncryptionKey = jose_core::EncryptionKey<super::A256Kw>;
    pub type DecryptionKey = jose_core::DecryptionKey<super::A256Kw>;

    pub fn encryption_key(
        bytes: impl Into<Vec<u8>>,
    ) -> Result<EncryptionKey, jose_core::JoseError> {
        Ok(jose_core::key::Key::new(super::make_kek(bytes, 32)?))
    }
