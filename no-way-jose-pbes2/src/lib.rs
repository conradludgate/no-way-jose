//! PBES2 (password-based) key management for JWE: [`Pbes2Hs256A128Kw`], [`Pbes2Hs384A192Kw`],
//! [`Pbes2Hs512A256Kw`].
//!
...
//!
//! PBKDF2 derives a KEK from the password; a random CEK is wrapped and `p2s` / `p2c` are written
//! to the protected header. Pair with a content algorithm such as [`A128Gcm`](no_way_jose_aes_gcm::A128Gcm).
//!
//! ```
