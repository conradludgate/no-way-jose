//! ECDH-ES and ECDH-ES + AES Key Wrap for JWE: [`EcdhEs`], [`EcdhEsA128Kw`], [`EcdhEsA192Kw`],
//! [`EcdhEsA256Kw`].
//!
...
//!
//! Curves: P-256, P-384 ([RFC 7518](https://www.rfc-editor.org/rfc/rfc7518)), X25519 ([RFC 8037](https://www.rfc-editor.org/rfc/rfc8037)).
//! Each encrypt builds an ephemeral key pair; the ephemeral public key is sent as `epk` in the
//! protected header. [`EncryptionKey`](no_way_jose_core::EncryptionKey) holds the recipient's
//! long-term private key ([`EcPrivateKey`]).
//!
//! ```
