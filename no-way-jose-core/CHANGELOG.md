...
## [0.1.0-rc.3](https://github.com/conradludgate/no-way-jose/compare/no-way-jose-core-v0.1.0-rc.2...no-way-jose-core-v0.1.0-rc.3) - 2026-04-08

### Fixed

- resolve clippy doc warnings from documentation overhaul

### Other

- *(core)* add module-level documentation
- *(core)* overhaul crate-level documentation
- *(core)* add docs module with architecture, how-to, and algorithm table
